...
def load_data():
    ...
    df = df[['period', 'value', 'country (label)']]
    df = df.rename(columns={'period': 'Year', 'value': 'Value', 'country (label)': 'Country Name'})
    return df
